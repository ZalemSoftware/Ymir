...
/**
 * Fragmento de obtenção de hora com tema igual ao do Android 5.<br>
 * <br>
 * Trata-se apenas de uma modificação do TimePickerDialog do projeto <a href="https://github.com/wdullaer/MaterialDateTimePicker">MaterialDateTimePicker</a>
 * que utiliza o esquema de fragmentos do support library.<br>
 * Existe uma <a href="https://github.com/wdullaer/MaterialDateTimePicker/issues/30">questão</a> no projeto refente a fazê-lo utilizar o support library também, então se isto algum dia acontecer, esta classe pode ser removida.
 *
 * @author wdullaer
 */
public class TimePickerFragment extends DialogFragment implements OnValueSelectedListener {
    ...
    public static TimePickerFragment newInstance(OnTimeSetListener callback,
                                               int hourOfDay, int minute, boolean is24HourMode) {
